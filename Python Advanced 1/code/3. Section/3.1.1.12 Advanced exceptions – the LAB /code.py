...
def batteries_check():
    try:
        print("The batteries are optimal")
    except:
        raise RocketNotReadyError("Problem with batteries")

def circuits_check():   
    try:
        print("The circuits are optimal")
    except:
        raise RocketNotReadyError("Problem with circuits")
